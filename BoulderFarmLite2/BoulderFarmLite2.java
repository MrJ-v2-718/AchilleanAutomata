...
public class BoulderFarmLite2 {
    ...
    public static void main(String[] args) throws AWTException {
        new BoulderFarmLite2();
    }

    public BoulderFarmLite2() throws AWTException {
        ...
        int iterations = Integer.parseInt(JOptionPane.showInputDialog(null, menuStrings[0] + menuStrings[1] +
                menuStrings[2] + menuStrings[3], "Boulder Farm Lite 2.0", JOptionPane.QUESTION_MESSAGE));
        ...
        JOptionPane.showMessageDialog(null, startStrings[0] +
                startStrings[1], "Boulder Farm Lite 2.0", JOptionPane.INFORMATION_MESSAGE);
        ...
        JOptionPane.showMessageDialog(null, endStrings[0] +
                endStrings[1], "Boulder Farm Lite 2.0", JOptionPane.INFORMATION_MESSAGE);
        //   Command Center Exit
    }
