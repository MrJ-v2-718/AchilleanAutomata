...
public class BoulderFarmLite3 {
    ...
    public static void main(String[] args) throws AWTException {
        ...
        new BoulderFarmLite3();
    }

    public BoulderFarmLite3() throws AWTException {
        foulTarnished = new Robot();
        String version = "Boulder Farm Lite 3.0";
        ...
        JOptionPane.showMessageDialog(null, endStrings[0] +
                endStrings[1], version, JOptionPane.INFORMATION_MESSAGE);
    }
    ...
    // Method for single key press and duration
